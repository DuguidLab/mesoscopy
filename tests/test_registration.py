...
def test_load_preprocessed_h5(preproc_h5):
    session_id, deltaf, ts = register._load_preprocessed(preproc_h5)
...
def test_load_preprocessed_nwb(preproc_nwb):
    session_id, deltaf, ts = register._load_preprocessed(preproc_nwb, nwb=True)
...
#     nwb = register._update_nwb(nwbfile, preproc_h5, tform_mock)
#     assert nwb.processing["ophys"]["corrected"].data
#     assert nwb.processing["ophys"]["xy_translation"].data
#     assert nwb.processing["ophys"]["CCFRegisteredSeries"].data


def test_register_landmarks_cli(): ...


def test_add_landmarks_gui(): ...
